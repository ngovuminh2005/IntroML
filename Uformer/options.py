...
class Options():
    ...
    def init(self, parser):        
        ...
        parser.add_argument('--muon_weight_decay', type=float, default=None, help='Muon weight decay; defaults to --weight_decay')
        parser.add_argument('--muon_nesterov', action='store_true', help='use Muon Nesterov momentum')
        parser.add_argument('--muon_no_nesterov', action='store_false', dest='muon_nesterov', help='disable Muon Nesterov momentum')
        parser.set_defaults(muon_nesterov=True)
        parser.add_argument('--muon_ns_steps', type=int, default=5, help='Muon Newton-Schulz steps')
        parser.add_argument('--muon_aux_lr', type=float, default=None, help='Aux Adam learning rate; defaults to --lr_initial')
        parser.add_argument('--muon_aux_weight_decay', type=float, default=None, help='Aux Adam weight decay; defaults to --weight_decay')
        parser.add_argument('--muon_aux_beta1', type=float, default=0.9, help='Aux Adam beta1')
        parser.add_argument('--muon_aux_beta2', type=float, default=0.999, help='Aux Adam beta2')
        parser.add_argument('--muon_aux_eps', type=float, default=1e-8, help='Aux Adam epsilon')
